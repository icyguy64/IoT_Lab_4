...
def customOnMessage(message):
    print('Received vehicle emission data on topic %s: %s\n' % (message.topic, message.payload))
...
while True:
    if args.mode == 'both' or args.mode == 'publish':
        ...
        message['vehicle_CO'] = df.iloc[loopCount, 1]
        message['vehicle_CO2'] = df.iloc[loopCount, 2]
        message['vehicle_HC'] = df.iloc[loopCount, 3]
        message['vehicle_NOx'] = df.iloc[loopCount, 4]
        message['vehicle_PMx'] = df.iloc[loopCount, 5]
